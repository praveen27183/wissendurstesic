...
const WorkshopCard = memo(({ workshop, index, bg, onClick }) => (
  <div
    className="group flex flex-col bg-[rgba(10,10,15,0.85)] backdrop-blur-md border border-st-blue/20 rounded-xl overflow-hidden cursor-pointer hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(37,99,255,0.15)] transition-all duration-300"
  ...
  >
    <div className="relative w-full aspect-video overflow-hidden">
      ...
      <div className="absolute top-4 right-4 bg-black/60 backdrop-blur-md border border-st-blue/30 px-3 py-1.5 rounded-full z-10 transition-transform group-hover:scale-105">
